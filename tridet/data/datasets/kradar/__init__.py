...
DATASET_DICTS_BUILDER = {
    'kradar_train_good_v3': (build_kradar_dataset, dict(label_path='kradar_cam_aligned_v3.json', split_type='train')),
    'kradar_test_good_v3': (build_kradar_dataset, dict(label_path='kradar_cam_aligned_v3.json', split_type='test')),
}
